...
def load_model(file_path: str):
    ...
    try:
        ...
        return model  # model is saved in variable clf which is used to call the load _model function which return the model.pkl
...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    try:
        ...
        return df  # test data is loaded and returned here
...
def evaluate_model(clf, X_test: np.ndarray, y_test: np.ndarray) -> dict:
    ...
    try:
        ...
        return metrics_dict  # stored in metrics variable defineed in MAIN function below
    except Exception as e:
...
def main():
    ...
    with mlflow.start_run() as run:  # Start an MLflow run
        try:
            clf = load_model('D:/Projects/mlops_miniproject/mlops-mini-project/models/model.pkl')
            test_data = load_data('D:/Projects/mlops_miniproject/mlops-mini-project/data/processed/test_bow.csv')
            ...
            save_metrics(metrics, 'D:/Projects/mlops_miniproject/mlops-mini-project/reports/metrics.json')
